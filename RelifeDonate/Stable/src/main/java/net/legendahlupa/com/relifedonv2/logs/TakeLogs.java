...
public class TakeLogs {
    ...
    public static void takelogsonline(CommandSender sender, int dmoney, Player target) {
        try {
    ...
    public static void takelogsoffline(OfflinePlayer targetoffline, CommandSender sender, int dmoney) {
        try {
