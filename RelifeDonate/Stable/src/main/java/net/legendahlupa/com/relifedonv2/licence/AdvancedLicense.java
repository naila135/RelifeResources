package net.legendahlupa.com.relifedonv2.licence;
...
public class AdvancedLicense {
	...
	private String securityKey = "9RM1VSGH{№F]\\8Q?:\\XC\\0S,R*\\Q}VK{W3!";
	...
	public boolean register() {
		...
		log(0, "Подключение к серверу лицензий...");
		ValidationType vt = isValid();
		if (vt == ValidationType.VALID) {
			log(1, ChatColor.GREEN + "Лицензия обнаружена!");
			log(0, "[]==========[License-System]==========[]");
			return true;
		} else {
			log(1, ChatColor.RED +"Лицензия не действительная");
			log(1, ChatColor.RED +"Ошибка " + vt.toString());
			log(1, ChatColor.RED +"Отключение плагина!");
			log(0, "[]==========[License-System]==========[]");
