...
public class GiveCommand implements CommandExecutor {
    ...
    public GiveCommand(File dataFolder) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        try {
            ...
            */
            sender.sendMessage(ChatColor.GREEN + "Вы успешно выдали " + args[1] + " очко игроку " + args[0]);
            /*
             * Запись данных в logs.yml
             */
            data.set(args[0] + ".second",(Integer.parseInt(args[1]) * 3600) + second_from_config);
        ...
        logs.setLogs(args[0], sender, Integer.parseInt(args[1]), "Give");
        /*
         * Сохранение файла
         */
        try {
